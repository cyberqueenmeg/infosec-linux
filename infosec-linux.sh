...
packageManager() {
    ...
    if [[$packageManger -eq 1]]; then
        ...
        echo "Starting Pacmaninstallation script"
        $(line)
        ./pacman-installer
    elif [[$packageManager -eq 3]]; then
...
echo "Please note that some software is proprietary. All software is legally acquired from official sources and checked for integrity in this script."
$(packageManager)
