...
if [ "$selection" = "1" ] || [ "$selection" = "2" ]; then
    if [ "$selection" = 1 ]; then
        ...
        if [ "$cyberselection" == "2" ]; then
            ...
            echo "Please open VirtualBox, highlight your virtual machine, click Settings, click Storage, click IDE, click the DVD drive on the IDE, and navigate to the folder with the ISO and add it to the storage controller. Then, start the machine."
	    fi
